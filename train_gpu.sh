...
#SBATCH --output=job_slurm/%J.train_gpu_encdec.out
#SBATCH --job-name=train_gpu_encdec
...
./train.lua -sceneNum 21 -g -arch enc_dec  -bs 128 -bsperscene 20 -patchSizeTr 64 -epoch 20 -data_dir ./data_mb2014_dark
